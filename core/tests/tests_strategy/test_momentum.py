...
def test_aroon(ta: TechnicalAnalysis):
    result = ta.momentum.aroon(period=14)
...
def test_ultosc(ta: TechnicalAnalysis):
    result = ta.momentum.ultosc(timeperiod1=7, timeperiod2=14, timeperiod3=28)
